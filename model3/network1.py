...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 8, kernel_size=3, padding=0, bias=False), # Input Channels - 1, Output Channels - 12
            nn.ReLU(),
            nn.BatchNorm2d(8),
        ...
        self.conv4 = nn.Sequential(
            ...
            nn.BatchNorm2d(16),
            nn.Dropout(dropout_rate)
        ) # Output Size - 12, Receptive Field - 10
        ...
        self.conv5 = nn.Sequential(
            ...
            nn.BatchNorm2d(10),
            nn.Dropout(dropout_rate)
        ) # Output Size - 10, Receptive Field - 14
        ...
        self.conv6 = nn.Sequential(
            ...
            nn.BatchNorm2d(16),
            nn.Dropout(dropout_rate)
        ) # Output Size - 8, Receptive Field - 18

        # Convolution Layer 6 - Output Size - 6
        self.conv7 = nn.Sequential(
            nn.Conv2d(16, 8, kernel_size=3, padding=0, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(8),
            nn.Dropout(dropout_rate)
        ) # Output Size - 6, Receptive Field - 22
        # o/p - 4
        self.conv8 = nn.Sequential(
            nn.Conv2d(8, 10, kernel_size=3, padding=0, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(10),
            nn.Dropout(dropout_rate)
        ) #Output Size - 4, Receptive Field - 26
